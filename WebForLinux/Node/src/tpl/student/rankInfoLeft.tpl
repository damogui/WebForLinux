        ...
        <div class="top mouse_hide team">
            ...
            <div class="rights mouse_hide team" style="border-bottom:0;border-left:0;">
                <p class="our_team">
                    {{each Mates as v i}}
