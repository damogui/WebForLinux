<div class="voice">
    ...
    <div class="remumber none" >
        <div class="wordWrap">
		{{if RemeberType==1}}
		<div class="remebertype type1">

		</div>
		
		{{else if RemeberType==2}}
		<div class="remebertype type2">

		</div>
		{{else if RemeberType==3}}
		<div class="remebertype type3">

		</div>
		{{else if RemeberType==4}}
		<div class="remebertype type4">

		</div>
		{{else if RemeberType==5}}
		<div class="remebertype type5">

		</div>
	{{/if}}
		<div class="remebertext">
		<div>【{{RemeberType | GetRemeberType}}】</div>
		<div>{{Rember}}</div>
		</div>
		</div>
    </div>
